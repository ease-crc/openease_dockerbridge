...
class DockerBridge(pyjsonrpc.HttpRequestHandler):
    ...
    @pyjsonrpc.rpcmethod
    def start_user_container(self, user_name, neem_id, neemHubSettings, neem_version='latest', knowrob_image='knowrob', knowrob_version='latest'):
        check_containername(user_name, 'container_name')
        # check_containername(neem_group, 'container_name')
        check_containername(neem_id, 'container_name')
        ...
        dockermanager.start_user_container(user_name, neem_id, neemHubSettings, neem_version, knowrob_image, knowrob_version)
